...
class Bet_Stats_Template_Loader extends Gamajo_Template_Loader {
  /**
   ...
   * @var string
   */
   protected $filter_prefix = 'bet_stats';
   ...
   * @var string
   */
   protected $theme_template_directory = 'bet-stats';
   ...
   * @var string
   */
   protected $plugin_directory = BET_STATS_PLUGIN_DIR;
